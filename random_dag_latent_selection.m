...
for iRCT =1:nRCTs
    ...
    nSelected = randsample(1:3,1);
    selvars = sort(randsample(nVars+1:nVarsOr, nSelected));
    ...
    if sum(inExperimental)==0
        ...
        [theta_i, logprobDegivDoHw(:, iRCT), algo] = scoreExperimentalAdjSetsJTSelInf(allSets, rnodespost, orderpost, ...
